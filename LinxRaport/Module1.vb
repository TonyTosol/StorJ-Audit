...
Module Module1
    Private Sender As New HttpSender("http://95.216.196.150:6000/raport/") ''\/("http://95.216.196.150:5000/monitoring/")/\
    ...
    Private Sub Monitoring()
        ...
        Try
            ...
            Dim tmpnode As New Node With {.Name = NodeName,
                                                    ...
                                                    .storageDaily = Math.Round(storageDaily / 720000000000000, 3)}
